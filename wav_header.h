...
typedef struct wav_header {
    ...
    uint32_t wav_size; // Size of the wav portion of the file, after the first 8 bytes. File size - 8
    ...
    uint32_t data_bytes; // Number of bytes in data. Samples_num * num_channels * sample byte size
} wav_header_t;
